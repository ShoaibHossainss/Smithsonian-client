  ...
  const handleAddSpot = e => {
    ...
    return (
        <div>
          ...
          <Navbar></Navbar>
          <h3 className="text-center text-black text-2xl font-semibold mb-4 mt-10">Add New Spot</h3>
            <form onSubmit={handleAddSpot} className="mx-auto mb-10 mt-10  rounded-2xl bg-[#f3f6fd] p-4">
