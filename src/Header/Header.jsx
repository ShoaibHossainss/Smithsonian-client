...
const Header = () => {
    return (
        <div className=' lg:w-[1320px] md:w-[750px] w-[365px] mx-auto rounded-2xl mt-10'>
      ...
      >
        ...
        <h3 className='-translate-y-10 text-center text-white text-3xl p-1 rounded-b-2xl bg-[#41505c]'>Bali</h3>
          </div></SwiperSlide>
        <SwiperSlide><div>
        <img className='rounded-3xl'  src={Slide2} alt="" />
        <h3 className='-translate-y-10 text-center text-white text-3xl p-1 rounded-b-2xl bg-[#41505c]'>Sundarban</h3>
          </div></SwiperSlide>
        <SwiperSlide><div>
        <img className='rounded-3xl '  src={Slide3} alt="" />
        <h3 className='-translate-y-10 text-center text-white text-3xl p-1 rounded-b-2xl bg-[#41505c]'>Rangamati</h3>
        </div></SwiperSlide>
        <SwiperSlide>
          <div>
          <img className='rounded-3xl '  src={Slide4} alt="" />
          <h3 className='-translate-y-10 text-center text-white text-3xl p-1 rounded-b-2xl bg-[#41505c]'>Cox Bazar</h3>
          </div>
        </SwiperSlide>
        <SwiperSlide>
          <div>
          <img className='rounded-3xl '  src={Slide5} alt="" />
          <h3 className='-translate-y-10 text-center text-white text-3xl p-1 rounded-b-2xl bg-[#41505c]'>Pattaya</h3>
          </div>
        </SwiperSlide>
        <SwiperSlide>
          <div>
          <img className='rounded-3xl '  src={Slide6} alt="" />
          <h3 className='-translate-y-10 text-center text-white text-3xl p-1 rounded-b-2xl bg-[#41505c]'>Phi Phi Islands</h3>
          </div>
        </SwiperSlide>
        <SwiperSlide>
          <div>
          <img className='rounded-3xl '  src={Slide7} alt="" />
          <h3 className='-translate-y-10 text-center text-white text-3xl rounded-b-2xl p-1 bg-[#41505c]'>Borobudur Temple</h3>
          </div>
        </SwiperSlide>
        <SwiperSlide>
          <div>
          <img className='rounded-3xl '  src={Slide8} alt="" />
          <h3 className='-translate-y-10 text-center text-white text-3xl p-1 rounded-b-2xl bg-[#41505c]'>Chiang Mai</h3>
          </div>
        </SwiperSlide>
        <SwiperSlide>
          <div>
          <img className='rounded-3xl '  src={Slide9} alt="" />
          <h3 className='-translate-y-10 text-center text-white text-3xl p-1 rounded-b-2xl bg-[#41505c]'>Ha Long Bay</h3>
          </div>
        </SwiperSlide>
